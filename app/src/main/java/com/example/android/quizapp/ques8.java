...
public class ques8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button2 = findViewById(R.id.show8);
    ...
    public void ans8(View view) {
        ImageView qw = findViewById(R.id.img8);
        TextView qwe = findViewById(R.id.ans8);
    ...
    public void answer8(View view) {
        ...
        else if ((op3.isChecked() && op1.isChecked()) && (count == 0) && (!op2.isChecked()) && (!op4.isChecked())) {
            count = 1;
            op3.setChecked(true);
            op1.setChecked(true);
        ...
        else if ((count == 0) && (op1.isChecked() || op4.isChecked() || op2.isChecked() || op3.isChecked())) {
            count = 1;
