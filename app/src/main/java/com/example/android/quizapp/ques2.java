...
public class ques2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button2 = findViewById(R.id.show2);
    ...
    public void ans2(View view) {
        ImageView qw = findViewById(R.id.img2);
        TextView qwe = findViewById(R.id.ans2);
    ...
    public void answer2(View view) {
        ...
        RadioGroup radio2;
        radio2 = findViewById(R.id.radio);
