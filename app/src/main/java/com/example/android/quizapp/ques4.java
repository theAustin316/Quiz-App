...
public class ques4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button2 = findViewById(R.id.show4);
    ...
    public void page5(View view) {
        Intent intent = new Intent(this, ques5.class);
    ...
    public void ans4(View view) {
        ImageView qw = findViewById(R.id.img4);
        TextView qwe = findViewById(R.id.ans4);
    ...
    public void answer4(View view) {
        ...
        // wring answer given, show answer is set to visible
